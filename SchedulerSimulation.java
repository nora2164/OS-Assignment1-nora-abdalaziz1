...
class Process implements Runnable {
    ...
    public Process(String name, int burstTime, int timeQuantum, int priority) {
        ...
        this.lastQueuedTime = creationTime;
    }
...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        while (!processQueue.isEmpty()) {
            ...
            process.waitingTime += (now - process.lastQueuedTime);
            ...
            if (!process.isFinished()) {
                if (!processQueue.isEmpty()) {
                    ...
                    System.out.println(process.getName() + " is the last process → running to completion");
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,
        ...
        process.lastQueuedTime = System.currentTimeMillis();
